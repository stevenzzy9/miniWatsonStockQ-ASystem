	...
	<body>
		<center>
			...
			<s:iterator value="answerCate" status="st" id="answerCate">
				<div id="link">
					<a href="GetCompanyInfo?id=<s:property value="id"/>">
						<h1>
							<s:property value="key"/>点击进入公司主页
						</h1>
					</a>
				</div>
				<s:iterator value="value" status="st1" id="anscate">
				<div class="B_r">
				<div class="title_100">
					<h2>
						<s:property value="name"/>
						<s:if test="answerType==8">分红配送</s:if>
						<s:elseif test="answerType==9">收入构成</s:elseif>
						<s:elseif test="answerType==10">财务指标</s:elseif>
						<s:elseif test="answerType==11">历史行情</s:elseif>
						<s:else>公司高管</s:else>
					</h2>
				</div>
